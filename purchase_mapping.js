function handler(params) {
    ...
    const sourceData = {
        ...
        expected_arrival_date: "2025-11-30T00:00:00Z", //ensureTimezone(cin7Transfer.RequiredByDate || cin7Transfer.DepartureDate),
        country_code: "US",
        ...
        boxes: lines.map(line => ({
            line_items: [{
                ...
                lot_expiration_date: ensureTimezone(line.ExpirationDate)
            }],
